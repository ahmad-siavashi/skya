...
Demonstrates :func:`skya.compare`. Five VMs arrive in a sequence
...
from skya import App, DataCenter, PM, Request, VM, compare
from skya.policies import FirstFit, Placement, SpaceShared, TimeShared
