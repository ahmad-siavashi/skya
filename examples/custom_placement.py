...
is found. Compare with :class:`skya.policies.FirstFit`, which always
...
Only :meth:`Placement.select_host` is overridden, to choose the host.
...
from skya.policies import Placement, SpaceShared, TimeShared
