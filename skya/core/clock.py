...
A :class:`Clock` is a small wrapper around one numeric counter holding the
current simulated time, in user-defined units. Each :class:`skya.Simulation`
...
jittered or fractional arrivals, and :class:`skya.network.Link`
...
*cycles per time unit* - but :class:`skya.metrics.Energy` reports kWh,
