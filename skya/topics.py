...
serialization), but :meth:`skya.EventQueue.subscribe`
...
Subclasses of :class:`skya.models.App` (and of :class:`skya.models.Daemon`)
...
that come with Skya; custom subclasses publish plain strings outside
the enum.
"""
...
class Topic(StrEnum):
    ...
    serialization, raw event dispatch - while still being a closed,
    ...
    fires (see :meth:`skya.policies.Placement.migrate_vm` with
    ``duration > 0``)."""
    ...
    of a timed one - see :meth:`skya.policies.Placement.migrate_vm`)."""
