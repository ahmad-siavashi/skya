...
:data:`skya.Topic.APP_START`).

It models one quantity: how long a payload takes to travel from one
endpoint to another. :meth:`~Link.transmission_time` is the cost formula
...
own model that publishes :data:`skya.Topic.LINK_DELIVER`).
"""
